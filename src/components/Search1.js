    ...
    render() {
        ...
        return (
            <>
                ...
                {/* <div>Выберите варианты отображения:
                    <div><input type="radio" name="display" value="list" checked={this.state.displayType === 'list'} onChange={this.handlerDisplay}/><span>список</span></div>
                    <div><input type="radio" name="display" value="tile" checked={this.state.displayType === 'tile'} onChange={this.handlerDisplay}/><span>плитка</span></div>
                </div> */}
                                ...
                                (
                                    ...
                                    (
                                        <button className='btn'
                                            key={index} onClick={()=>(this.setPage(el))}
